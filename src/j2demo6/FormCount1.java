 ...
 * @author minhdq
 */
public class FormCount1 extends javax.swing.JFrame implements Runnable{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCount1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCount1().setVisible(true);
            }
        });
    }
